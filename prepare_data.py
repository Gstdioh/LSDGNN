...
def prepare_adj_data(sensor_ids_file, distance_file, output_pkl_file=None, normalized_k=0.1, graph_type='direct', **kwargs):
    # 构建邻接矩阵
    sensor_ids = []
...
def prepare_traffic_data(data_file, data_file_type='npz', add_time_in_day=True, add_day_in_week=False,
    ...
    if data_file_type == 'npz':
        ...
        if add_time_in_day:
            ...
            time_ind = [i % 288 / 288 for i in range(times)]
        ...
        if add_day_in_week:
            ...
            # D2STGNN中使用1位来编码星期, 特征加 1
            # numerical day_in_week
            day_in_week = [(i // 288) % 7 for i in range(times)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_filename',
                        default=r"configs/PEMS03/prepare.yaml",
                        type=str,
